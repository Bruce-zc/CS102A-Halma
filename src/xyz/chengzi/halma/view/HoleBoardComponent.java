...
public class HoleBoardComponent extends JComponent implements Listenable<InputListener>, GameListener {
    static Color BOARD_COLOR_1 = new Color(255, 255, 204);
    static Color BOARD_COLOR_2 = new Color(170, 170, 170);
    ...
    public HoleBoardComponent(int size, int dimension) {
    ...
    private void initGridComponents() {
        for (int row = 0; row < dimension; row++) {
            for (int col = 0; col < dimension; col++) {
                if(col<5||col>(dimension-6)||row<5&col>=5&col<=dimension-6||row>dimension-6&col>=5&col<=dimension-6){
